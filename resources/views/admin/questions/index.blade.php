    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                @include('messages')
                <div class="card">
                    <div class="card-header top-card">{{ __('admin.Questions') }}</div>
                    <div class="card-body">
                        <div class="p-3 add-new">
                            <a href="{{ url('questions/create') }}" class="btn btn-success btn-sm" title="{{ __('admin.Add new Question') }}">
                                <i class="fa fa-plus" aria-hidden="true"></i> {{ __('admin.Add new Question') }}
                            </a>
                        </div>
...
<script src="{{ URL::asset('js/ajax/getQuestions.js') }}" data-lang="{{ App::getLocale() }}" id='dataTableAjaxScript'></script>
