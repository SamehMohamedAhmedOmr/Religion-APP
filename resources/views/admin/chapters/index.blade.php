    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                @include('messages')
                <div class="card">
                    <div class="card-header top-card">{{ __('admin.chapters') }}</div>
                    <div class="card-body">
                        <div class="p-3 add-new">
                            <a href="{{ url('chapters/create') }}" class="btn btn-success btn-sm" title="{{ __('admin.Add new Chapter') }}">
                                <i class="fa fa-plus" aria-hidden="true"></i> {{ __('admin.Add new Chapter') }}
                            </a>
                        </div>
                            ...
                            <table class="table col-11 m-auto p-0 table-hover" id="get-data">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="no-sort">{{ __('admin.Name') }}</th>
...
<script src="{{ URL::asset('js/ajax/getChapters.js') }}" data-lang="{{ App::getLocale() }}" id='dataTableAjaxScript'></script>
