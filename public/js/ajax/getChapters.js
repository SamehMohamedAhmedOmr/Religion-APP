        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data) {
                    edit = '<a href="chapters/' + data + '/edit" class="btn btn-sm btn-info text-white ml-2"><i class="fas fa-marker"></i> </a>';
